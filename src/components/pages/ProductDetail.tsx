...
const DetailPage: React.FC = () => {
  ...
  const handleAddToCart = () => {
    console.log(`Added ${product.name} (${selectedWeight} lbs x ${quantity}) to cart`);
    setOpen(true);
  };
      ...
      <div className="max-w-6xl mx-auto px-4 py-10 space-y-6">
        ...
        <div className="flex flex-col md:flex-row gap-10">
          ...
          <div className="md:w-1/2 space-y-3">
            {/* Main carousel */}
            <div className="relative overflow-hidden rounded-2xl bg-white shadow-sm" ref={emblaRef}
                ...
                {product.images.map((_, i) => (
                  <button
                    ...
                    style={{
                      ...
                      height: "7px",
                      background: selectedIndex === i ? "#1ca7a6" : "rgba(255,255,255,0.7)",
                    }}
                  />
                ))}
              </div>
            ...
            <div className="flex gap-2 overflow-x-auto slim-scrollbar pb-1">
              {product.images.map((img, index) => (
                <img
                  ...
                  style={{
                    border: selectedIndex === index ? "2px solid #1ca7a6" : "2px solid transparent",
                    boxShadow: selectedIndex === index ? "0 0 0 3px rgba(28,167,166,0.15)" : "none",
          ...
          <div className="md:w-1/2 flex flex-col space-y-5">
            ...
            >
              <span className="text-[13px] text-gray-400 font-medium">Price</span>
              ...
              <div className="flex flex-wrap gap-2">
                {product.weights.map((w) => (
                  <button
                    ...
                    style={{
                      background: selectedWeight === w ? "#1ca7a6" : "white",
                      color: selectedWeight === w ? "white" : "#6b7280",
                      border: selectedWeight === w ? "1.5px solid #1ca7a6" : "1.5px solid #e5e5e5",
                    }}
                  >
                    {w} lbs
                  </button>
            ...
            <div className="flex items-center gap-3">
              ...
              >
                ...
                <span className="px-4 py-2.5 text-[15px] font-semibold text-gray-800 min-w-[40px] text-center"
                  style={{ borderLeft: "1.5px solid #e5e5e5", borderRight: "1.5px solid #e5e5e5" }}>
                  {quantity}
                </span>
                <button
              ...
              <button onClick={handleAddToCart} className="btn flex-1 text-center">
                Add to Cart
              </button>
            </div>
            ...
            <div className="space-y-2.5 text-[13px] text-gray-500">
              <p className="text-gray-400 italic">Shipping calculated at checkout.</p>
            ...
            <div className="flex items-center gap-3 pt-1">
              <span className="text-[12px] uppercase tracking-[0.12em] font-semibold text-gray-400">Share</span>
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="sm:max-w-md border-0 p-0 overflow-hidden bg-white shadow-2xl rounded-2xl">
          ...
          <div className="px-8 py-8 flex flex-col items-center text-center">
            ...
            >
              <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#1ca7a6" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
                <polyline points="20 6 9 17 4 12" />
              </svg>
            </div>

            <h2 className="salsify text-[28px] text-gray-800 leading-tight">Added to Cart!</h2>
            <p className="text-[13px] text-gray-400 mt-1 tracking-wide">Your item is waiting in your cart.</p>

            <div className="w-full h-px my-6" style={{ background: "linear-gradient(to right, transparent, #d3d3d3, transparent)" }} />

            <div className="flex flex-col sm:flex-row gap-3 w-full">
              <button onClick={() => navigate("/cart")} className="btn flex-1 text-center">
                View Cart
              </button>
              <button onClick={() => navigate("/checkout")} className="btn2 flex-1 text-center">
                Check Out
              </button>
            </div>
